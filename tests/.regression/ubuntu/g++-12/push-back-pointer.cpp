...
/usr/include/c++/12/bits/stl_vector.h:1276:7: note: candidate: ‘void std::vector<_Tp, _Alloc>::push_back(const value_type&) [with _Tp = int; _Alloc = std::allocator<int>; value_type = int]’ (near match)
 1276 |       push_back(const value_type& __x)
      |       ^~~~~~~~~
...
[...]
      ...
      |                 |
      |                 int*
/usr/include/c++/12/bits/stl_vector.h:1293:7: note: candidate: ‘void std::vector<_Tp, _Alloc>::push_back(value_type&&) [with _Tp = int; _Alloc = std::allocator<int>; value_type = int]’ (near match)
 1293 |       push_back(value_type&& __x)
      |       ^~~~~~~~~

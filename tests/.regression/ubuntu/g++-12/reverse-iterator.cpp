...
/usr/include/c++/12/bits/basic_string.h:2040:7: note: candidate: ‘std::__cxx11::basic_string<_CharT, _Traits, _Alloc>& std::__cxx11::basic_string<_CharT, _Traits, _Alloc>::erase(size_type, size_type) [with _CharT = char; _Traits = std::char_traits<char>; _Alloc = std::allocator<char>; size_type = long unsigned int]’
 2040 |       erase(size_type __pos = 0, size_type __n = npos)
      |       ^~~~~
...
[...]
      ...
      |             ~~~~~~~~~~^~~~~~~~~
/usr/include/c++/12/bits/basic_string.h:2060:7: note: candidate: ‘std::__cxx11::basic_string<_CharT, _Traits, _Alloc>::iterator std::__cxx11::basic_string<_CharT, _Traits, _Alloc>::erase(__const_iterator) [with _CharT = char; _Traits = std::char_traits<char>; _Alloc = std::allocator<char>; iterator = std::__cxx11::basic_string<char>::iterator; __const_iterator = std::__cxx11::basic_string<char>::const_iterator]’
 2060 |       erase(__const_iterator __position)
      |       ^~~~~
/usr/include/c++/12/bits/basic_string.h:2060:7: note:   candidate expects 1 argument, 2 provided
/usr/include/c++/12/bits/basic_string.h:2080:7: note: candidate: ‘std::__cxx11::basic_string<_CharT, _Traits, _Alloc>::iterator std::__cxx11::basic_string<_CharT, _Traits, _Alloc>::erase(__const_iterator, __const_iterator) [with _CharT = char; _Traits = std::char_traits<char>; _Alloc = std::allocator<char>; iterator = std::__cxx11::basic_string<char>::iterator; __const_iterator = std::__cxx11::basic_string<char>::const_iterator]’
 2080 |       erase(__const_iterator __first, __const_iterator __last)
      |       ^~~~~

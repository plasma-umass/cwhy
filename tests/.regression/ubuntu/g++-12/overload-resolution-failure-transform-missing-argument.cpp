...
/usr/include/c++/12/bits/stl_algo.h:4252:5: note: candidate: ‘template<class _IIter, class _OIter, class _UnaryOperation> _OIter std::transform(_IIter, _IIter, _OIter, _UnaryOperation)’
 4252 |     transform(_InputIterator __first, _InputIterator __last,
      |     ^~~~~~~~~
...
/home/runner/work/cwhy/cwhy/tests/c++/overload-resolution-failure-transform-missing-argument.cpp:41:19: note:   candidate expects 4 arguments, 3 provided
   41 |     std::transform(v.begin(), v.end(), [](int i) { return i * i; });
      |     ~~~~~~~~~~~~~~^~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
/usr/include/c++/12/bits/stl_algo.h:4290:5: note: candidate: ‘template<class _IIter1, class _IIter2, class _OIter, class _BinaryOperation> _OIter std::transform(_IIter1, _IIter1, _IIter2, _OIter, _BinaryOperation)’
 4290 |     transform(_InputIterator1 __first1, _InputIterator1 __last1,
      |     ^~~~~~~~~

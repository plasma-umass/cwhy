...
File `/usr/include/c++/11/pstl/glue_algorithm_defs.h`:
```
...
/usr/include/c++/11/bits/stl_algo.h:4285:5: note: candidate: ‘template<class _IIter, class _OIter, class _UnaryOperation> _OIter std::transform(_IIter, _IIter, _OIter, _UnaryOperation)’
 4285 |     transform(_InputIterator __first, _InputIterator __last,
      |     ^~~~~~~~~
...
In file included from /usr/include/c++/11/algorithm:62,
                 from /home/runner/work/cwhy/cwhy/tests/c++/overload-resolution-failure-transform-missing-argument.cpp:36:
/usr/include/c++/11/bits/stl_algo.h:4323:5: note: candidate: ‘template<class _IIter1, class _IIter2, class _OIter, class _BinaryOperation> _OIter std::transform(_IIter1, _IIter1, _IIter2, _OIter, _BinaryOperation)’
 4323 |     transform(_InputIterator1 __first1, _InputIterator1 __last1,
      |     ^~~~~~~~~

...
File `/Users/runner/work/cwhy/cwhy/tests/c++/sfinae-trailing-return-type.cpp`:
```
...
This is my error:
```
/Users/runner/work/cwhy/cwhy/tests/c++/sfinae-trailing-return-type.cpp:12:5: error: no matching function for call to 'g'
    g(17);
    ^
